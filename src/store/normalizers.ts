...
export const normalizarReceta = (
  ...
  tiposComida:
    Array.isArray(r.tiposComida)
      ? r.tiposComida
      : [],

  ingredientesBase:
    Array.isArray(r.ingredientesBase)
      ? r.ingredientesBase
      : [],
  ...
  caracteristicas:
    Array.isArray(r.caracteristicas)
      ? r.caracteristicas
      : [],
...
export const normalizarInventario = (
  ...
  ubicacion:
    item.ubicacion ?? 'despensa',

  fechaCaducidad:
    item.fechaCaducidad ?? null,

  fechaDescongelar:
    item.fechaDescongelar ?? null,
